...
> **How to use this module:** Everything you need to complete this week's work is in these articles. The live lectures walk the same ground off script, so treat them as a bonus, not a requirement. Read the concept articles, follow the practice exercises in your engine, and check [[a1-spec|the Assignment 1 spec]] before you record.
...
5. [[a1-spec|Assignment 1: Scenes & Transforms]]: paced this week. The first assignment of the course.
