...
- A flat scene: fifteen objects, all siblings at the root. That's a list wearing a tree costume. Requirement 1 wants depth.
...
- Prefab shown once. Requirement 4 requires two instances plus a propagating edit, because "reusable" is the entire point of the requirement.
- The camera left at its default spawn, or moved but unexplained. Requirement 5 is the cheapest requirement on this list and the most-failed. One placed camera, one sentence of intent.
...
*Video structure that works: [[recording-a1|Recording Your Assignment 1 Video]].*
